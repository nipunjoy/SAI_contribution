...
typedef enum _sai_neighbor_entry_attr_t
{
     ...
     * @validonly SAI_NEIGHBOR_ENTRY_ATTR_PACKET_ACTION == SAI_PACKET_ACTION_TRAP or SAI_NEIGHBOR_ENTRY_ATTR_PACKET_ACTION == SAI_PACKET_ACTION_COPY or SAI_NEIGHBOR_ENTRY_ATTR_PACKET_ACTION == SAI_PACKET_ACTION_LOG
     */
