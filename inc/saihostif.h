...
typedef enum _sai_hostif_user_defined_trap_type_t
{
    ...
    /**
     * @brief Router traps
     * Generated by route entry hit with packet action trap/log/copy
     */
     ...
     *
     * Generated by neighbor table entry hit with action trap/log/copy, or by neighbor table miss
     */
    ...
    /** IPMC traps */
    SAI_HOSTIF_USER_DEFINED_TRAP_TYPE_IPMC,

    /** L2MC traps */
    SAI_HOSTIF_USER_DEFINED_TRAP_TYPE_L2MC,

    /** My Sid traps */
    SAI_HOSTIF_USER_DEFINED_TRAP_TYPE_MY_SID,
